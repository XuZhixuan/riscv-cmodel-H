...
public:
    ...
    void Evaluate(){
        if(this->m_CalcuPipe.OutPort->valid){
            ...
            this->AddrGen(insn);		
			RISCV::AccessMode mode = RISCV::AccessMode::Read;
			RISCV::Fault fault;
    ...
    void SendLoadReq(){
        ...
        if(Success){
            this->m_dCachePort.ReceiveMemReq(loadReq,std::bind(&Func_LDU::ReceiveLoadResponse,this,std::placeholders::_1));
        } 
    }

    void ReceiveLoadResponse(MemResp_t memResp){
