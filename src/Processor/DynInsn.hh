...
struct DynInsn
{
    ...
    funcType_t   Fu;
    uint8_t      SubOp;             // insn, such as mret, ecall, ...
    ...
    /* ISA register address */
    IsaRegId_t   IsaRs1;
    IsaRegId_t   IsaRs2;
    IsaRegId_t   IsaRd;

    /* register type: NONE or INT; if NONE, set IsaReg 0 */
    RegType_t    Rs1Type;
    RegType_t    Rs2Type;
    RegType_t    RdType;

    /* final register address: not Isa directly because of rename */
    PhyRegId_t   PhyRs1;
    PhyRegId_t   PhyRs2;
    PhyRegId_t   PhyRd;
    PhyRegId_t   LPhyRd;
